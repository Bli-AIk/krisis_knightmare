local KrisPhase1_10, super = Class(Wave)
...
function KrisPhase1_10:getArenaCenterY()
...
function KrisPhase1_10:playInitialRudeBusterSound()
...
function KrisPhase1_10:spawnInitialRudeBuster(attacker)
...
function KrisPhase1_10:playThrust(attacker)
...
function KrisPhase1_10:onStart()
...
function KrisPhase1_10:onEnd(death)
    for _, attacker in ipairs(self:getAttackers()) do
...
function KrisPhase1_10:update()
    super.update(self)
end

return KrisPhase1_10
