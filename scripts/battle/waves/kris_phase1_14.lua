...
function KrisPhase1_14:getArenaCenterY()
...
function KrisPhase1_14:getInitialRudeBusterOptions()
    return {
        ...
        followup_bullet_count = 2,
        followup_split_diamonds = true,
        followup_diamond_count_divisor = 2,
    }
end

function KrisPhase1_14:playInitialRudeBusterSound()
...
function KrisPhase1_14:spawnInitialRudeBuster(attacker)
...
function KrisPhase1_14:playThrust(attacker)
...
function KrisPhase1_14:onStart()
...
function KrisPhase1_14:onEnd(death)
    for _, attacker in ipairs(self:getAttackers()) do
...
function KrisPhase1_14:update()
    super.update(self)
end

return KrisPhase1_14
